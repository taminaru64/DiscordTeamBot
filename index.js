                ...
                if (interaction.isChatInputCommand()) {
                    ...
                    // === /team_rename ===
                        ...
                        if (
                            ...
                            return interaction.editReply("❌ 同じ名前のチームがすでに存在します。");
                        }

                        if (oldRole) await oldRole.setName(newRoleName);
                        if (channel.parent) await channel.parent.setName(newCategoryName);

                        await interaction.editReply(
                            `✅ チーム名を「${oldName}」から「${newName}」に変更しました。`,
                        );
                    }
                }
